...
namespace zSpace.Core
{
    public partial class ZCore
    {
        ...
        {
            SetRenderTargetLeft      = 10000,
            SetRenderTargetRight     = 10001,
            FrameDone                = 10002,
            DisableStereo            = 10003,
            InitializeLRDetect       = 10004,
            ShutdownLRDetect         = 10005,
            UpdateLRDetectFullscreen = 10006,
            UpdateLRDetectWindowed   = 10007,
            SyncLRDetectFullscreen   = 10008,
            SyncLRDetectWindowed     = 10009,
            UpdateWindowPosition     = 10010,
        }
